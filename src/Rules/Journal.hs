...
rules assetHashes = do
  match "journal/**" $ do
    ...
    compile
      $   pandocCompiler
      >>= loadAndApplyTemplate "templates/journal/journal.html" postCtx
      >>= saveSnapshot "content"
      >>= loadAndApplyTemplate "templates/journal/journal-page.html" postCtx
      >>= loadAndApplyTemplate "templates/journal/layout-j.html"     defaultContext
  ...
  create ["j/archive.html"] $ do
    ...
    compile $ do
      ...
      makeItem ""
        >>= loadAndApplyTemplate "templates/journal/journal_archive.html" indexCtx
        >>= loadAndApplyTemplate "templates/journal/layout-j.html"        layoutCtx
        >>= rewriteAssetUrls assetHashes
  ...
  create ["j/index.html"] $ do
    ...
    compile $ do
      ...
      makeItem ""
        >>= loadAndApplyTemplate "templates/journal/journal_home.html" homeCtx
        >>= loadAndApplyTemplate "templates/journal/layout-j.html"     layoutCtx
        >>= rewriteAssetUrls assetHashes
